...
import {
  ThrowingAwardAuditRepository,
} from "./fakes/throwing-award-audit.repository";

describe.sequential(
  "Award Recommendation Audit Rollback Integration",
  () => {
    ...
    it(
      "rolls back when award audit creation fails",
      async () => {
        const service =
          new DefaultAwardRecommendationApplicationService(
            new ThrowingAwardAuditRepository(),
          );
